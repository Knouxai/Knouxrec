...
const ToolboxPanel: React.FC = () => {
  ...
  // الحصول على النماذج المطلوبة لأداة معينة
  const getRequiredModels = (toolId: string): string => {
    const modelMappings: Record<string, string> = {
      "ai-video-generator": "VideoCrafter + GPT4All",
      "ai-background-remover": "MODNet / U-2-Net",
      "ai-animation": "AnimateDiff + Stable Diffusion",
      "ai-upscaler": "Real-ESRGAN",
      "ai-voice-clone": "So-VITS",
      "vocal-remover": "Spleeter",
      "noise-remover": "RNNoise",
      "photo-enhancer": "Real-ESRGAN",
      "text-to-speech": "Bark TTS",
      "speech-to-text": "Whisper",
    };
    return modelMappings[toolId] || "نموذج محلي";
  };
  ...
  const getTaskType = (
    ...
    const taskTypes: Record<string, "video" | "audio" | "image" | "text"> = {
      "ai-video-generator": "text",
      "text-to-speech": "text",
    ...
    return taskTypes[toolId] || "text";
  };

  // الحصول على العملية
  const getOperation = (toolId: string): string => {
    const operations: Record<string, string> = {
      "ai-video-generator": "text_to_video",
      "ai-background-remover": "background_removal",
      "speech-to-text": "speech_to_text",
      "ai-voice-clone": "voice_change",
      "ai-animation": "ai_animation",
      "ai-upscaler": "image_upscaler",
      "video-trimmer": "trim_video",
      "video-merger": "merge_video",
      "noise-remover": "noise_reduction",
      "vocal-remover": "vocal_remover",
    };
    return operations[toolId] || toolId;
  };
