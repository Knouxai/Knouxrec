  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 className="text-2xl font-orbitron font-bold text-knoux-purple mb-6">
          Settings
        </h2>

        <div className="space-y-6">
          <div>
            <h3 className="text-lg font-bold font-orbitron mb-3 text-knoux-neon">
              🎨 Appearance
            </h3>
            <div className="glass-card p-4 rounded-xl border border-knoux-purple/20 hover:border-knoux-purple/40 transition-all">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  {theme === "dark" ? (
                    <MoonIcon className="w-6 h-6 text-knoux-neon" />
                  ) : (
                ...
                <div className="flex items-center gap-3">
                  ...
                  />
                  <MoonIcon className="w-5 h-5 text-knoux-neon" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="glass-card p-4 rounded-xl border border-knoux-purple/20 space-y-4">
              <div className="flex items-center justify-between">
                <label
                  htmlFor="liveFilter"
                  className="font-rajdhani font-bold text-white flex items-center gap-2"
                >
                  <FilterIcon className="w-5 h-5 text-knoux-purple" /> Video
                  Filter
                </label>
                <select
                  id="liveFilter"
          ...
          <div>
            <h3 className="text-lg font-bold font-orbitron mb-3 text-knoux-neon-blue/80">
              Workflow
            </h3>
            <div className="p-4 interactive-card rounded-lg space-y-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-md text-[var(--primary-text)]">
                      Instant Trim
                    </h4>
                    <p className="text-xs text-[var(--secondary-text)]">
                      Trim video immediately after recording.
                    </p>
                  </div>
                </div>
                <ToggleSwitch
                  enabled={localSettings.instantTrimEnabled}
                  onChange={() => handleToggle("instantTrimEnabled")}
                />
              </div>
              <div>
                <label
                  htmlFor="fileNamePattern"
                  className="block font-semibold text-md text-[var(--primary-text)] mb-2"
                >
                  File Name Pattern
                </label>
                <input
                ...
                <p className="text-xs text-[var(--secondary-text)] mt-2">
                  Placeholders:{" "}
                  <kbd className="font-sans border border-gray-500 rounded-sm px-1 text-xs">
                    [DATE]
                  </kbd>{" "}
                  <kbd className="font-sans border border-gray-500 rounded-sm px-1 text-xs">
                    [TIME]
          ...
          <div>
            ...
            <div className="p-4 interactive-card rounded-lg space-y-4">
              <div className="flex items-center justify-between">
                <label className="font-semibold text-md text-[var(--primary-text)]">
                  Start / Stop
                </label>
                <div className="w-1/2">
                  <HotkeyCaptureInput
                    value={localSettings.hotkeys.startStop}
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="w-1/2">
                  <HotkeyCaptureInput
                    value={localSettings.hotkeys.pauseResume}
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="w-1/2">
                  <HotkeyCaptureInput
                    value={localSettings.hotkeys.screenshot}
            ...
            <div className="p-4 interactive-card rounded-lg flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-[var(--secondary-text)]">
                    Auto-generate title, summary & keywords after recording.
                  </p>
                </div>
              </div>
              <ToggleSwitch
                enabled={localSettings.aiProcessingEnabled}
